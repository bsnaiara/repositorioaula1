...
function preload(){
  ...
  //Carregando os sons e salvando em variaveis
...
function setup() {
  ...
  //Criando sprite do trex e adicionando animações
  trex = createSprite(50,160,20,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
  
  //Criando o sprite do nosso solo
  ground = createSprite(200,180,400,20);
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2;

  //Criando o sprite do solo invisivel
  ...
  //Definindo a colisão do trex
  trex.setCollider("rectangle",0,0,trex.width,trex.height);

  trex.debug = true
  
  //Definindo o valor inicial para o score
  score = 0;
